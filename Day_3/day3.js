...
// }
//question 14
// let numberOfYear = prompt('Enter The number of years you have spent')
// let secondsSpent =  365 * 24 *60 * 60 * numberOfYear
// alert(`You lived ${secondsSpent} seconds`);

//question 15i
// let anyDate = new Date();
// let month = anyDate.getMonth();
// let day = anyDate.getDate();
// let hour = anyDate.getHours();
// let minute = anyDate.getMinutes();
// console.log(day.toString().length)

// if(month.toString().length < 2 && day.toString().length < 2  && hour.toString().length < 2 &&  
// minute.toString().length < 2){
//     month = '0'+ month;
//     day= '0'+ day;
//     hour = '0'+ hour;
//     minute = '0'+ minute;
//     console.log(anyDate.getFullYear()+'-'+month+'-'+day+' '+ hour+':'+minute)
// }
// else{
//     console.log(anyDate.getFullYear()+'-'+month+'-'+day+' '+ hour+':'+minute)
// } 
...
//     hour = '0'+ hour;
//     minute = '0'+ minute;
//     console.log(day+'-'+month+'-'+anyDate.getFullYear()+' '+ hour+':'+minute)
